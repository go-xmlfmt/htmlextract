...
https://github.com/go-xmlfmt/htmlextract/releases  
...
- Pick & choose the binary executable that suits your OS and its architecture. E.g., for Linux, it would most probably be the `htmlextract_linux_VER_amd64` file. If your OS and its architecture is not available in the download list, please let me know and I'll add it.
